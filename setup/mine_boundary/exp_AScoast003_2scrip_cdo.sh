...
dir_saida='output_exp_AScoast002/'
...
for n in $(seq 0 $(( ${#vvars[@]} -1 )) ); do
    ...
    for n in 0 1 2 ; do
		...
		cdo -L -s -chname,h,dz_${v}${fronteirasuffix[$n]} obc_${v}_${fronteiranc[$n]} obc1_${v}_${fronteiranc[$n]}
        ...
        ${src}/fill_OBC_horz.py obc1_${v}_${fronteiranc[$n]} obc2_${v}_${fronteiranc[$n]}
...
tdef time 31 linear 01jan1900 1dy" > obc3_${v}_${fronteiraddf[$n]}
   done
